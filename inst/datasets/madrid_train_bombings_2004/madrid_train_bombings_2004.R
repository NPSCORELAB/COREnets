...
nodes <- .corenets_read_csv(
  .corenets_sys_file("datasets/madrid_train_bombings_2004/Madrid_Nodes_Public_Version2.csv")
)
edges <- .corenets_read_csv(
  .corenets_sys_file("datasets/madrid_train_bombings_2004/Madrid_Relations_Public_Version2.csv")
)
...
.description <- .corenets_read_lines(
  .corenets_sys_file("datasets/madrid_train_bombings_2004/description.txt")
)

.abstract <- .corenets_read_lines(
  .corenets_sys_file("datasets/madrid_train_bombings_2004/abstract.txt")
)

.bibtex <- bibtex::read.bib(
  .corenets_sys_file("datasets/madrid_train_bombings_2004/refs.bib")
)
...
.reference <- list(
  ...
  name         = "madrid_train_bombings_2004",
  tags         = c("terrorism"),
...
madrid_train_bombings_2004 <- list(
  reference = .reference,
  network  = .network
)

madrid_train_bombings_2004
